...
export default function ContactForm() {
  ...
  return (
    ...
    >
      ...
      <input type="email" placeholder="your@email" {...register("email", {})}  className="outline-none border-0 p-0 mx-2 focus:ring-0 placeholder:text-center placeholder:text-lg border-b border-accent dark:border-gray focus:border-accent dark:focus:border-gray bg-transparent"/>
