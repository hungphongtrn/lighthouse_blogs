  ...
  return (
    <footer className="mt-16 rounded-2xl bg-accent dark:bg-accentDark/90 m-2 sm:m-10 flex flex-col items-center text-light dark:text-dark">
      <h3 className="mt-16 font-medium dark:font-bold text-center capitalize text-2xl sm:text-3xl lg:text-4xl px-4">
        Illuminating the Future of AI and Deep Learning
      </h3>
      <p className="mt-5 px-4 text-center w-full sm:w-3/5 font-light dark:font-medium text-sm sm:text-base">
      Subscribe to learn more about AI and Deep Learning to stay ahead of the curve.
      </p>
      ...
      <div className="w-full mt-8 relative font-medium border-t border-solid border-light py-6 px-8 flex  flex-col md:flex-row items-center justify-between">
        <span className="text-center">
          &copy;2024 Lighthouse Research. All rights reserved.
        </span>
        <Link
          href="/sitemap.xml"
